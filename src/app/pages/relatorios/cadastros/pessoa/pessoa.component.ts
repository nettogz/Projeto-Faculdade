...
export default class PessoaComponent implements OnInit {
  ...
  paginationPerson: Pagination<any> = new Pagination<any>(5, pessoasRelatorio);
  personList:any[] = pessoasRelatorio;
